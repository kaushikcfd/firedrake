...
def FunctionSpace(mesh, family, degree=None, name=None, vfamily=None,
    ...
    if element.family() == "Real":
        ...
        new = impl.FunctionSpace(topology, element, name=name, real_tensorproduct=real_tensorproduct, should_reorder=should_reorder)
...
def VectorFunctionSpace(mesh, family, degree=None, dim=None,
                        name=None, vfamily=None, vdegree=None, should_reorder=True):
