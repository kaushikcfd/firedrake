...
class FunctionSpace(object):
    ...
    *intrinsically* vector-valued finite elements (such as the
    ...
    """
    def __init__(self, mesh, element, name=None, real_tensorproduct=False, should_reorder=True):
        ...
        sdata = get_shared_data(mesh, finat_element, real_tensorproduct=real_tensorproduct, should_reorder=should_reorder)
